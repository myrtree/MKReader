...
/* Set size of glyphs */
extern DECLSPEC void TTF_SetFontKegel(TTF_Font** font, int height);
...
extern DECLSPEC int SDLCALL TTF_SizeUTF16(TTF_Font *font, const Uint16 *text, int *w, int *h);
extern DECLSPEC int SDLCALL TTF_SizeUTF32(TTF_Font *font, const Uint32 *text, int *w, int *h);
...
extern DECLSPEC SDL_Surface * SDLCALL TTF_RenderUTF16_Solid(TTF_Font *font,
				const Uint16 *text, SDL_Color fg);
extern DECLSPEC SDL_Surface * SDLCALL TTF_RenderUTF32_Solid(TTF_Font *font,
...
extern DECLSPEC SDL_Surface * SDLCALL TTF_RenderUTF16_Shaded(TTF_Font *font,
				const Uint16 *text, SDL_Color fg, SDL_Color bg);
extern DECLSPEC SDL_Surface * SDLCALL TTF_RenderUTF32_Shaded(TTF_Font *font,
				const Uint32 *text, SDL_Color fg, SDL_Color bg);
...
extern DECLSPEC SDL_Surface * SDLCALL TTF_RenderUTF8_Blended(TTF_Font *font,
				const char *text, SDL_Color fg);
extern DECLSPEC SDL_Surface * SDLCALL TTF_RenderUTF16_Blended(TTF_Font *font,
				const Uint16 *text, SDL_Color fg);
extern DECLSPEC SDL_Surface * SDLCALL TTF_RenderUTF32_Blended(TTF_Font *font,
				const Uint32 *text, SDL_Color fg);
